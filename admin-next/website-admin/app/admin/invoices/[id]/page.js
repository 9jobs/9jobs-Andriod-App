...
export default async function InvoiceDetailPage({ params }) {
  ...
  return (
    <AdminShell eyebrow="Preview and email the branded invoice PDF" title={invoice.invoiceNumber}>
      <section className="admin-panel">
        ...
        <div className="admin-detail-grid">
          ...
          <div className="admin-detail-card">
            ...
            <DetailRow label="Week" value={invoice.weekLabel} />
          ...
          <div className="admin-panel__header">
            ...
            {invoice.generatedPdfUrl ? (
              <a
                ...
                href={`/admin/website-admin/api/invoices/${invoice._id}/preview-pdf`}
                rel="noreferrer"
                target="_blank"
              >
 Open Preview
          ...
          {invoice.generatedPdfUrl ? (
            <iframe
              ...
              src={`/admin/website-admin/api/invoices/${invoice._id}/preview-pdf`}
        ...
        <article className="admin-panel">
          <div className="admin-panel__header">
            ...
            <Link className="admin-link" href="/admin/website-admin/invoices">
 Back to list
               </Link>
          </div>
