...
const BACKEND_URL = process.env.NEXT_PUBLIC_BACKEND_URL?.trim() || (process.env.NODE_ENV === "development" ? "http://localhost:3000" : "https://backend-theta-ten-27.vercel.app");
...
export default function App() {
  ...
  const [websiteAdminPath, setWebsiteAdminPath] = useState("dashboard");
  ...
  const [isWebsiteAdminDropdownOpen, setIsWebsiteAdminDropdownOpen] = useState(false);
  ...
  const openWebsiteAdmin = async (path: string) => {
    const token = await ensureAdminToken();
    if (!token) {
    ...
    const response = await fetch('/admin/website-admin/api/admin/sso', {
      method: 'POST',
      headers: { Authorization: `Bearer ${token}` },
    });

    if (!response.ok) {
      showError('Unable to open Agreements & Invoices.');
      return;
    }

    setWebsiteAdminPath(path);
    setActiveTab("website_admin");
  };

  useEffect(() => {
    if (!isAdmin || authLoading || activeTab !== "dashboard") {
      return;
    }

    void openWebsiteAdmin("dashboard");
  ...
  const fetchUsers = async () => {
    ...
    if (process.env.NODE_ENV === "development" && !profileMap.has(previewTrackerClient.id)) {
    ...
    try {
      const payload = {
        ...
        admin_notes: JSON.stringify({
          notes: interviewForm.admin_notes,
          about_company: interviewForm.about_company,
          key_responsibilities: interviewForm.key_responsibilities,
          job_link: interviewForm.job_link,
  ...
  const openAddModal = (type: any) => {
    ...
    const defaultSavedJobUserId =
      type === "job" && activeTab === "saved_jobs"
        ? selectedTrackerClientId || users[0]?.id || (process.env.NODE_ENV === "development" ? previewTrackerClient.id : "")
        : "";
    // Clear forms
    setUserForm({
      id: "",
    ...
    <div className="admin-container">
      ...
      <aside className="sidebar">
        ...
        <nav className="sidebar-menu">
          <a className="sidebar-item" onClick={() => void openWebsiteAdmin("dashboard")}>
          ...
          <div style={{ display: "flex", flexDirection: "column" }}>
            <a
              className="sidebar-item website-admin-sidebar-item"
              onClick={() => setIsWebsiteAdminDropdownOpen((previous) => !previous)}
            >
              <Briefcase size={18} />
              <span style={{ flex: 1 }}>Agreements &amp; Invoices</span>
              <span style={{ fontSize: "12px", opacity: 0.9 }}>{isWebsiteAdminDropdownOpen ? "▾" : "▸"}</span>
            </a>
            {isWebsiteAdminDropdownOpen && (
              <div className="website-admin-dropdown" style={{ display: "flex", flexDirection: "column", gap: "2px", margin: "4px 0" }}>
                <div>
                  <a className="sidebar-item sidebar-subitem website-admin-sidebar-item" onClick={() => setIsAgreementsDropdownOpen((previous) => !previous)} style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    <span style={{ display: "flex", alignItems: "center", gap: "12px" }}><Files size={14} /><span>Agreements</span></span>
                    <span style={{ fontSize: "12px", opacity: 0.9 }}>{isAgreementsDropdownOpen ? "▾" : "▸"}</span>
                  </a>
                  {isAgreementsDropdownOpen && (
                    <div style={{ display: "flex", flexDirection: "column", gap: "2px", margin: "4px 0", paddingLeft: "18px" }}>
                      <a className="sidebar-item sidebar-subitem website-admin-sidebar-item" onClick={() => void openWebsiteAdmin("agreements/new")}><FileText size={14} /><span>Standard Plan Agreement</span></a>
                      <a className="sidebar-item sidebar-subitem website-admin-sidebar-item" onClick={() => void openWebsiteAdmin("fortnight-agreements/new")}><Files size={14} /><span>Fortnight Agreement</span></a>
                      <a className="sidebar-item sidebar-subitem website-admin-sidebar-item" onClick={() => void openWebsiteAdmin("agreements")}><PenLine size={14} /><span>Review Agreement</span></a>
                    </div>
                  )}
                </div>
                <div>
                  <a className="sidebar-item sidebar-subitem website-admin-sidebar-item" onClick={() => setIsInvoicesDropdownOpen((previous) => !previous)} style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    <span style={{ display: "flex", alignItems: "center", gap: "12px" }}><ReceiptText size={14} /><span>Invoices</span></span>
                    <span style={{ fontSize: "12px", opacity: 0.9 }}>{isInvoicesDropdownOpen ? "▾" : "▸"}</span>
                  </a>
                  {isInvoicesDropdownOpen && (
                    <div style={{ display: "flex", flexDirection: "column", gap: "2px", margin: "4px 0", paddingLeft: "18px" }}>
                      <a className="sidebar-item sidebar-subitem website-admin-sidebar-item" onClick={() => void openWebsiteAdmin("invoices/new")}><ReceiptText size={14} /><span>Create Invoice</span></a>
                      <a className="sidebar-item sidebar-subitem website-admin-sidebar-item" onClick={() => void openWebsiteAdmin("invoices")}><ReceiptText size={14} /><span>Review Invoice</span></a>
                    </div>
                  )}
                </div>
              </div>
      ...
      <main className="main-content">
        ...
        {activeTab === "website_admin" && (
          <iframe
            ...
            src={`/admin/website-admin/${websiteAdminPath}`}
            style={{ width: "100%", minHeight: "calc(100vh - 170px)", border: "none", display: "block" }}
          />
        )}
        {activeTab === "dashboard" && (
          <div>
              ...
              <form onSubmit={handleSaveInterview}>
                ...
                <div className="form-row">
                  <div className="form-group">
                    ...
                    <input type="text" className="form-input" value={interviewForm.company} onChange={(e) => setInterviewForm({ ...interviewForm, company: e.target.value })} />
                  </div>
                  <div className="form-group">
                    <label className="form-label">Job Link</label>
                    <input type="url" className="form-input" value={interviewForm.job_link} onChange={(e) => setInterviewForm({ ...interviewForm, job_link: e.target.value })} />
                  </div>
                </div>
                ...
                <div className="form-row">
                  <div className="form-group">
                    ...
                    <input type="text" className="form-input" value={interviewForm.interviewer_name} onChange={(e) => setInterviewForm({ ...interviewForm, interviewer_name: e.target.value })} />
                  </div>
                  <div className="form-group">
                    <label className="form-label">Interviewer Email</label>
                    <input type="email" className="form-input" value={interviewForm.interviewer_email} onChange={(e) => setInterviewForm({ ...interviewForm, interviewer_email: e.target.value })} />
                  </div>
                </div>
                ...
                <div className="form-row">
                  <div className="form-group">
                    ...
                    <input type="text" className="form-input" value={interviewForm.location} onChange={(e) => setInterviewForm({ ...interviewForm, location: e.target.value })} />
                  </div>
                  <div className="form-group">
                    <label className="form-label">Meeting Link</label>
                    <input type="url" className="form-input" value={interviewForm.meeting_link} onChange={(e) => setInterviewForm({ ...interviewForm, meeting_link: e.target.value })} />
                  </div>
                </div>

                <div className="form-group">
                  <label className="form-label">About Company</label>
                  <textarea rows={3} className="form-input" value={interviewForm.about_company} onChange={(e) => setInterviewForm({ ...interviewForm, about_company: e.target.value })} />
                </div>

                <div className="form-group">
                  <label className="form-label">Key Responsibilities</label>
                  <textarea rows={3} className="form-input" value={interviewForm.key_responsibilities} onChange={(e) => setInterviewForm({ ...interviewForm, key_responsibilities: e.target.value })} />
                </div>

                <div className="form-group">
                  <label className="form-label">Notes</label>
                  <textarea rows={2} className="form-input" value={interviewForm.admin_notes} onChange={(e) => setInterviewForm({ ...interviewForm, admin_notes: e.target.value })} />
                </div>
